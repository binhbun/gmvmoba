print("https://discord.com/invite/eQYeYtRhjA")
toclipboard("https://discord.com/invite/eQYeYtRhjA")
...
if QuestC.Visible == true then
						...
						local Tab1 = Main.create("Menu chính")
						
						local Tab2 = Main.create("Người chơi")
						
						local Tab3 = Main.create("Dịch chuyển/Ngục tối")
						
						local Tab4 = Main.create("cửa hàng")
						
						local Tab5 = Main.create("khác")
